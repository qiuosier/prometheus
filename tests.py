...
class TestUpTimeCheck(TestCase):
    ...
    # This URL is considered UP
    up_url = "https://httpstat.us/200"
    # This URL is considered DOWN
    down_url = "https://httpstat.us/503"
    # This URL will trigger timeout
    timeout_url = "http://www.google.com:81"

    def test_parse_arguments(self):
        """Tests the parse_argument function, which allows user to specify a delay.
        """
        # The parse_arguments function returns the delay in seconds for the uptime checks
        # By default, the delay should be one second
